...
const PreviewImage = () => {
  ...
  return (
    <div>
      <div className='w-[340px] h-[340px] bg-black flex flex-col justify-center items-center bg-[url(https://zherring-portfolio.s3.amazonaws.com/basedghouls-bg.png)] bg-cover bg-center h-screen'>
